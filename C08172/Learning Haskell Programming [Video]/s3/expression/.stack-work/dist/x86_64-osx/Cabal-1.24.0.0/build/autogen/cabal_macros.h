...
/* package expression-0.1.0.0 */
#define VERSION_expression "0.1.0.0"
#define MIN_VERSION_expression(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "expression-0.1.0.0-LLH3ZZG0tgVL93rajMeVXb"

#define CURRENT_PACKAGE_KEY "expression-0.1.0.0-LLH3ZZG0tgVL93rajMeVXb"
